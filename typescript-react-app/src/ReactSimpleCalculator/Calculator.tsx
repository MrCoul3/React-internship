...
import {ThemeContext, themes, TypesThemes} from "../ContextData/Theme";
    ...
    return (
        <section id='Calculator'>
            <div className='text-center'>
                <header>
                    <div style={{background: bg === themes.light.background ? '#6294b8' : bg}} className="header-bg header-bg--light">

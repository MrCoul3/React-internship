...
function Iter5() {
    $(document).ready(() => {
// arrow functions
        let ask = () => window.confirm("Вы согласны?") ? alert("Вы согласились.") : alert("Вы отменили выполнение.")
        let btn = document.querySelector('.click-for-ask-btn');
...
// string = string.padStart(10,9);
    ...
    return (
        <button className={'click-for-ask-btn'}>click for ask</button>
    );
}
export default Iter5